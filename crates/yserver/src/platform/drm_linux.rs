...
///
/// A device with no connected connectors returns an empty output list.
/// This lets the KMS backend start with zero active outputs and wait for
/// RANDR/hotplug to populate the layout later.
///
/// # Panics
